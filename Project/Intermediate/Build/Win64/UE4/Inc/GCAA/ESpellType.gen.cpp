...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_GCAA_ESpellType_Hash() { return 1840996177U; }
	UEnum* Z_Construct_UEnum_GCAA_ESpellType()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ESpellType::Shield", (int64)ESpellType::Shield },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "Blink.DisplayName", "test" },
				{ "Blink.Name", "ESpellType::Blink" },
				{ "Default.DisplayName", "test" },
				{ "Default.Name", "ESpellType::Default" },
				{ "Fireball.DisplayName", "test" },
				{ "Fireball.Name", "ESpellType::Fireball" },
				{ "Lightning.DisplayName", "test" },
				{ "Lightning.Name", "ESpellType::Lightning" },
				{ "ModuleRelativePath", "Enumerators/ESpellType.h" },
				{ "Shield.DisplayName", "test" },
				{ "Shield.Name", "ESpellType::Shield" },
			};
#endif
