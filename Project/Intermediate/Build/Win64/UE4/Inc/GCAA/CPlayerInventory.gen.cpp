...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCPlayerInventory_Statics::NewProp_aPlayerInventory = { "aPlayerInventory", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCPlayerInventory, aPlayerInventory), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCPlayerInventory_Statics::NewProp_aPlayerInventory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCPlayerInventory_Statics::NewProp_aPlayerInventory_MetaData)) };
	...
	IMPLEMENT_CLASS(UCPlayerInventory, 3113041709);
