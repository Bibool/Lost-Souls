...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingNpc_Statics::NewProp_BulletBP_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingNpc_Statics::NewProp_walkSpeed = { "walkSpeed", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMovingNpc, walkSpeed), METADATA_PARAMS(Z_Construct_UClass_AMovingNpc_Statics::NewProp_walkSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingNpc_Statics::NewProp_walkSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingNpc_Statics::NewProp_runSpeed = { "runSpeed", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMovingNpc, runSpeed), METADATA_PARAMS(Z_Construct_UClass_AMovingNpc_Statics::NewProp_runSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingNpc_Statics::NewProp_runSpeed_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AMovingNpc_Statics::NewProp_spawnRandomPath = { "spawnRandomPath", nullptr, (EPropertyFlags)0x0040000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AMovingNpc), &Z_Construct_UClass_AMovingNpc_Statics::NewProp_spawnRandomPath_SetBit, METADATA_PARAMS(Z_Construct_UClass_AMovingNpc_Statics::NewProp_spawnRandomPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMovingNpc_Statics::NewProp_spawnRandomPath_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingNpc_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingNpc_Statics::NewProp_BulletBP,
	...
	IMPLEMENT_CLASS(AMovingNpc, 1074272352);
