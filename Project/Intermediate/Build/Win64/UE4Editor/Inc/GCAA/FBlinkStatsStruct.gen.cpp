...
static struct FScriptStruct_GCAA_StaticRegisterNativesFBlinkStatsStruct
{
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Warp_Effect_Strength_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Warp_Effect_Strength;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_VFX_Blink_Start_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_VFX_Blink_Start;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_VFX_Blink_End_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_VFX_Blink_End;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Warp_Effect_Strength_MetaData[] = {
		{ "Category", "BlinkStatsStruct" },
		{ "Comment", "/* Higher zooms out, lower zooms in */" },
		{ "ModuleRelativePath", "Structures/FBlinkStatsStruct.h" },
		{ "ToolTip", "Higher zooms out, lower zooms in" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Warp_Effect_Strength = { "Warp_Effect_Strength", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlinkStatsStruct, Warp_Effect_Strength), METADATA_PARAMS(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Warp_Effect_Strength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Warp_Effect_Strength_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Animation_MetaData[] = {
		{ "Category", "BlinkStatsStruct" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlinkStatsStruct, Animation), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Animation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Animation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Skill_Icon_MetaData[] = {
		{ "Category", "BlinkStatsStruct" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Skill_Icon = { "Skill_Icon", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlinkStatsStruct, Skill_Icon), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Skill_Icon_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Skill_Icon_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_Start_MetaData[] = {
		{ "Category", "BlinkStatsStruct" },
		{ "Comment", "/* Particle effect to play when the blink starts. */" },
		{ "ModuleRelativePath", "Structures/FBlinkStatsStruct.h" },
		{ "ToolTip", "Particle effect to play when the blink starts." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_Start = { "VFX_Blink_Start", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlinkStatsStruct, VFX_Blink_Start), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_Start_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_Start_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_End_MetaData[] = {
		{ "Category", "BlinkStatsStruct" },
		{ "Comment", "/* Particle effect to play when the blink end. */" },
		{ "ModuleRelativePath", "Structures/FBlinkStatsStruct.h" },
		{ "ToolTip", "Particle effect to play when the blink end." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_End = { "VFX_Blink_End", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlinkStatsStruct, VFX_Blink_End), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_End_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_End_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Warp_Effect_Strength,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Animation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_Skill_Icon,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_Start,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlinkStatsStruct_Statics::NewProp_VFX_Blink_End,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FBlinkStatsStruct_Hash() { return 1313495376U; }
