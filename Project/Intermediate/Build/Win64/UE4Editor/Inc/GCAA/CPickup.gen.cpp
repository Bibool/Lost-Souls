...
// Cross Module References
	GCAA_API UEnum* Z_Construct_UEnum_GCAA_EPickupType();
...
// End Cross Module References
	static UEnum* EPickupType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_GCAA_EPickupType, Z_Construct_UPackage__Script_GCAA(), TEXT("EPickupType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPickupType(EPickupType_StaticEnum, TEXT("/Script/GCAA"), TEXT("EPickupType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_GCAA_EPickupType_Hash() { return 4097236515U; }
	UEnum* Z_Construct_UEnum_GCAA_EPickupType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_GCAA();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPickupType"), 0, Get_Z_Construct_UEnum_GCAA_EPickupType_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EPickupType::Key", (int64)EPickupType::Key },
				{ "EPickupType::JournalEntry", (int64)EPickupType::JournalEntry },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "JournalEntry.Name", "EPickupType::JournalEntry" },
				{ "Key.Name", "EPickupType::Key" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACPickup_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACPickup_OnOverlapBegin, "OnOverlapBegin" }, // 1658544386
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_ACPickup_Statics::NewProp_PickupName = { "PickupName", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACPickup, PickupName), METADATA_PARAMS(Z_Construct_UClass_ACPickup_Statics::NewProp_PickupName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACPickup_Statics::NewProp_PickupName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACPickup_Statics::NewProp_ContainerNumber_MetaData[] = {
		{ "Category", "Configure" },
		{ "ModuleRelativePath", "Interactables/CPickup.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_ACPickup_Statics::NewProp_ContainerNumber = { "ContainerNumber", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACPickup, ContainerNumber), METADATA_PARAMS(Z_Construct_UClass_ACPickup_Statics::NewProp_ContainerNumber_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACPickup_Statics::NewProp_ContainerNumber_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACPickup_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACPickup_Statics::NewProp_ContainerNumber,
	};
	...
	IMPLEMENT_CLASS(ACPickup, 1266783580);
