...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpell_Statics::NewProp_m_pcPlayer_MetaData[] = {
		{ "Comment", "// Pointer to the current player.\n" },
		{ "ModuleRelativePath", "SpellManager/Spells/Spell.h" },
		{ "ToolTip", "Pointer to the current player." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpell_Statics::NewProp_m_pcPlayer = { "m_pcPlayer", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpell, m_pcPlayer), Z_Construct_UClass_ACPlayer_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASpell_Statics::NewProp_m_pcPlayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpell_Statics::NewProp_m_pcPlayer_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpell_Statics::NewProp_m_pcSpellManager_MetaData[] = {
		{ "Comment", "// Pointer to the current spell manager.\n" },
		{ "ModuleRelativePath", "SpellManager/Spells/Spell.h" },
		{ "ToolTip", "Pointer to the current spell manager." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASpell_Statics::NewProp_m_pcSpellManager = { "m_pcSpellManager", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpell, m_pcSpellManager), Z_Construct_UClass_ASpellManager_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASpell_Statics::NewProp_m_pcSpellManager_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpell_Statics::NewProp_m_pcSpellManager_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASpell_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpell_Statics::NewProp_m_pcPlayer,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASpell_Statics::NewProp_m_pcSpellManager,
	};
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASpell_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UPoolStatusIdentifier_NoRegister, (int32)VTABLE_OFFSET(ASpell, IPoolStatusIdentifier), false },
		};
	...
	IMPLEMENT_CLASS(ASpell, 2490091464);
