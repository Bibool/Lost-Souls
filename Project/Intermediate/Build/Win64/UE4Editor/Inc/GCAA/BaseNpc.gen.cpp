...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABaseNpc_onAttackOverlapBegin_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//overlap attack functions\n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "overlap attack functions" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABaseNpc_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABaseNpc_onAttackOverlapBegin, "onAttackOverlapBegin" }, // 4284308168
		{ &Z_Construct_UFunction_ABaseNpc_onAttackOverlapEnd, "onAttackOverlapEnd" }, // 1165118594
		{ &Z_Construct_UFunction_ABaseNpc_TakeDamage, "TakeDamage" }, // 2614694096
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_movingNpc_MetaData[] = {
		...
		{ "Category", "AI | Path" },
		{ "Comment", "//bool which checks if the npc can move or not \n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "bool which checks if the npc can move or not" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_attackRange_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "AI | Combat" },
		{ "Comment", "//float which sets the npcs attack range \n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "float which sets the npcs attack range" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_DamageableComponent_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Components" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_DamageableComponent = { "DamageableComponent", nullptr, (EPropertyFlags)0x00200800000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, DamageableComponent), Z_Construct_UClass_UDamageComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_DamageableComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_DamageableComponent_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_maxHealth_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "AI | Stats" },
		{ "Comment", "//float for the max health\n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "float for the max health" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_maxHealth = { "maxHealth", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, maxHealth), METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_maxHealth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_maxHealth_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_damageAmount_MetaData[] = {
		...
		{ "Comment", "//damage amount function\n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "damage amount function" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_damageAmount = { "damageAmount", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, damageAmount), METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_damageAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_damageAmount_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "AI | Combat" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
	};
#endif
	void Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive_SetBit(void* Obj)
	{
		((ABaseNpc*)Obj)->isActive = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive = { "isActive", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ABaseNpc), &Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive_SetBit, METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_BehaviorTreeComponent_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_BehaviorTreeComponent = { "BehaviorTreeComponent", nullptr, (EPropertyFlags)0x0020080000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, BehaviorTreeComponent), Z_Construct_UClass_UBehaviorTreeComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_BehaviorTreeComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_BehaviorTreeComponent_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseNpc_Statics::NewProp_Attackmontage_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "AI | Animation" },
		{ "Comment", "//makes the anim montage component\n" },
		{ "ModuleRelativePath", "NPC/BaseNpc.h" },
		{ "ToolTip", "makes the anim montage component" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_Attackmontage = { "Attackmontage", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, Attackmontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_Attackmontage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_Attackmontage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABaseNpc_Statics::NewProp_meleeCollision = { "meleeCollision", nullptr, (EPropertyFlags)0x002008000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABaseNpc, meleeCollision), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABaseNpc_Statics::NewProp_meleeCollision_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABaseNpc_Statics::NewProp_meleeCollision_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABaseNpc_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseNpc_Statics::NewProp_DamageableComponent,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseNpc_Statics::NewProp_isActive,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABaseNpc_Statics::NewProp_BehaviorTreeComponent,
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ABaseNpc_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UDeathInterface_NoRegister, (int32)VTABLE_OFFSET(ABaseNpc, IDeathInterface), false },
		};
	...
	IMPLEMENT_CLASS(ABaseNpc, 3485434672);
