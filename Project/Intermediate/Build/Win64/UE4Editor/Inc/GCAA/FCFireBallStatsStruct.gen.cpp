...
static struct FScriptStruct_GCAA_StaticRegisterNativesFCFireBallStatsStruct
{
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Structures/FCFireBallStatsStruct.h" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Animation_MetaData[] = {
		{ "Category", "CFireBallStatsStruct" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCFireBallStatsStruct, Animation), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Animation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Animation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Skill_Icon_MetaData[] = {
		{ "Category", "CFireBallStatsStruct" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Skill_Icon = { "Skill_Icon", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCFireBallStatsStruct, Skill_Icon), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Skill_Icon_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Skill_Icon_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Animation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FCFireBallStatsStruct_Statics::NewProp_Skill_Icon,
	...
	uint32 Get_Z_Construct_UScriptStruct_FCFireBallStatsStruct_Hash() { return 1431633656U; }
