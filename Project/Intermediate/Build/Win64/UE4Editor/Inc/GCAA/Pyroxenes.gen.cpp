...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APyroxenes_Statics::NewProp_BodyMesh_MetaData[] = {
		...
		{ "Comment", "//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = FloatingAI)\n//class UFloatingAI* FloatingAI; //floating ai made by mia \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "NPC/Pyroxenes.h" },
		{ "ToolTip", "UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = FloatingAI)\nclass UFloatingAI* FloatingAI; floating ai made by mia" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APyroxenes_Statics::NewProp_HeadMesh_MetaData[] = {
		{ "Category", "AI | Components" },
		{ "Comment", "// has a seperate body mesh and head mesh for now, in the future these will be skeletal meshes\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "NPC/Pyroxenes.h" },
		{ "ToolTip", "has a seperate body mesh and head mesh for now, in the future these will be skeletal meshes" },
	};
#endif
	...
	IMPLEMENT_CLASS(APyroxenes, 3632796991);
