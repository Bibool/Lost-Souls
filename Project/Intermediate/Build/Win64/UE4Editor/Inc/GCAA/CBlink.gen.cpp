...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACBlink_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACBlink_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UPoolStatusIdentifier_NoRegister, (int32)VTABLE_OFFSET(ACBlink, IPoolStatusIdentifier), false },
		};
	...
	IMPLEMENT_CLASS(ACBlink, 739030698);
